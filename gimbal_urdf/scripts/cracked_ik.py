...
class AppForm():
    ...
    def __init__(self):
        ...
        self.joint_pub = rospy.Publisher("/joint_pubs", Vector3, queue_size=2)
        self.pose_goal = None
    ...
    def callback(self, msg):
        ...
        if self.pose_goal is not None:
            if self.prev_pose_goal != self.pose_goal:
                # self.on_draw()
    ...
    #     path = self.unicode(QFileDialog.getSaveFileName(self, 
    #                     'Save file', '', 
    #                     file_choices))
    #     if path:
    ...
    def on_draw(self):
        ...
        if self.scenario == 2:
            ...
            if not np.isnan(self.G_T_active).any():
                ...
                # rospy.init_node('new_ik')
                joint_angles = Vector3()
                joint_angles.x = self.val_theta_1
                joint_angles.y = self.val_theta_2
                joint_angles.z = self.val_theta_3
    ...
    #     # self.axes.set_aspect('equal') # method doesn't exist in matplot version 3.1.2
    ...
    #     self.cbx_theta_1.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_theta_1.valueChanged.connect(self.on_update_values)
        
    #     self.cbx_theta_2 = QCheckBox('reset')
    #     self.cbx_theta_2.setChecked(False)
    #     #self.connect(self.cbx_theta_2, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_theta_2.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_theta_2.valueChanged.connect(self.on_update_values)

    #     self.cbx_theta_3 = QCheckBox('reset')
    #     self.cbx_theta_3.setChecked(False)
    #     #self.connect(self.cbx_theta_3, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_theta_3.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_theta_3.valueChanged.connect(self.on_update_values)

    #     self.cbx_theta_4 = QCheckBox('reset')
    #     self.cbx_theta_4.setChecked(False)
    #     #self.connect(self.cbx_theta_4, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_theta_4.stateChanged.connect(self.on_update_values)
    ...
    #     self.cbx_theta_5.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_theta_5.valueChanged.connect(self.on_update_values)

    #     self.cbx_theta_6 = QCheckBox('reset')
    #     self.cbx_theta_6.setChecked(False)
    #     #self.connect(self.cbx_theta_6, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_theta_6.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_theta_6.valueChanged.connect(self.on_update_values)
    ...
    #     self.sld_wz.valueChanged.connect(self.on_update_values)

    #     self.cbx_posx = QCheckBox('reset')
    #     self.cbx_posx.setChecked(False)
    #     #self.connect(self.cbx_posx, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_posx.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_posx.valueChanged.connect(self.on_update_values)

    #     self.cbx_posy = QCheckBox('reset')
    #     self.cbx_posy.setChecked(False)
    #     #self.connect(self.cbx_posy, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_posy.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_posy.valueChanged.connect(self.on_update_values)
        
    #     self.cbx_posz = QCheckBox('reset')
    #     self.cbx_posz.setChecked(False)
    #     #self.connect(self.cbx_posz, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_posz.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_posz.valueChanged.connect(self.on_update_values)
        
    #     self.cbx_rotx = QCheckBox('reset')
    #     self.cbx_rotx.setChecked(False)
    #     #self.connect(self.cbx_rotx, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_rotx.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_rotx.valueChanged.connect(self.on_update_values)

    #     self.cbx_roty = QCheckBox('reset')
    #     self.cbx_roty.setChecked(False)
    #     #self.connect(self.cbx_roty, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_roty.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_roty.valueChanged.connect(self.on_update_values)
        
    #     self.cbx_rotz = QCheckBox('reset')
    #     self.cbx_rotz.setChecked(False)
    #     #self.connect(self.cbx_rotz, SIGNAL('stateChanged(int)'), self.on_update_values)
    #     self.cbx_rotz.stateChanged.connect(self.on_update_values)
    ...
    #     self.sld_rotz.valueChanged.connect(self.on_update_values)
...
# print(pose_goal.pose.position.x)
# print(pose_goal.pose.position.y)
# print(pose_goal.pose.position.z)
# print(pose_goal.pose.orientation.x)
# print(pose_goal.pose.orientation.y)
# print(pose_goal.pose.orientation.z)
# print(pose_goal.pose.orientation.w)
